...
const styles = {
  ...
  buttonEdit: { background: "linear-gradient(135deg, #f59e0b 0%, #f97316 100%)", border: "none", borderRadius: "999px", padding: "5px 11px", marginRight: "5px", cursor: "pointer", color: "#2b1800", fontWeight: 800 },
